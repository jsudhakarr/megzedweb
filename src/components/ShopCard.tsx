  ...
  return (
    ...
    >
      ...
      <div className="mt-3 flex items-center gap-1 justify-center">
        <h3 className="text-base font-semibold text-slate-900 line-clamp-1">{shop.shop_name}</h3>
      ...
      <div className="grid grid-cols-2 gap-3 w-full mt-4">
        ...
        <div className="flex items-center justify-center gap-2">
          ...
          <div className="text-left">
            ...
            <div className="text-sm font-semibold text-slate-900">{shop.items_count ?? 0}</div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-4 w-full h-1 rounded-full bg-slate-100 overflow-hidden" aria-hidden>
        <div
